...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_csv_path', type=str, help="path to the csv file having image file names and labels.")
    parser.add_argument('--images_root_dir', type=str, help="Root directory path to images folder.")
    parser.add_argument('--artifacts_dir',
                        type=str,
                        help="The root artifacts directory which will hold model artifacts.")
